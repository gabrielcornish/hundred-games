...
namespace AC
{
	...
	public class MainCamera : MonoBehaviour
	{
		 ...
		 */
		public void FadeOut (float _fadeDuration, Texture2D tempTex, bool forceCompleteTransition = true, CameraFadePauseBehaviour _cameraFadePauseBehaviour = CameraFadePauseBehaviour.Cancel)
		{
			if (tempTex != null)
			{
				SetFadeTexture (tempTex);
			}
			FadeOut (_fadeDuration, forceCompleteTransition, _cameraFadePauseBehaviour);
		}
		 ...
		 * <param name = "cameraFadePauseBehaviour">How to react to the game being paused (Cancel, Hide, Continue)</param>
		 */
		public virtual void FadeIn (float _fadeDuration, bool forceCompleteTransition = true, CameraFadePauseBehaviour _cameraFadePauseBehaviour = CameraFadePauseBehaviour.Cancel)
		{
			AssignFadeTexture ();
		 ...
		 * <param name = "cameraFadePauseBehaviour">How to react to the game being paused (Cancel, Hide, Continue)</param>
		 */
		public virtual void FadeOut (float _fadeDuration, bool forceCompleteTransition = true, CameraFadePauseBehaviour _cameraFadePauseBehaviour = CameraFadePauseBehaviour.Cancel)
		{
			AssignFadeTexture ();
		...
		public PlayerData SaveData (PlayerData playerData)
		{
			...
			if (attachedCamera)
			{
				...
				if (attachedCamera.gameObject.scene != gameObject.scene)
				{
